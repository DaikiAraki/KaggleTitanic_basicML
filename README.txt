...
Transformerユニットを用いたDeep Learningモデル（https://github.com/DaikiAraki/KaggleTitanic_DeepLearning_Transformer）の時に比べて、良い結果が得られるかと思っていたが、３モデルともKaggle提出時の正解率は75%前後であり、ほぼ同じ性能であった。
